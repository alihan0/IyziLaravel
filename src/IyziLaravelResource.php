...
use IyziLaravel\HashGenerator;
use IyziLaravel\IyziAuthV2Generator;
use IyziLaravel\IyziLaravelOptions;

class IyziLaravelResource extends ApiResource
{
    private $status;
    private $errorCode;
    ...
    protected static function getHttpHeaders(Request $request, IyziLaravelOptions $options)
    {
        $header = array(
    ...
    protected static function getHttpHeadersV2($uri, Request $request = null, IyziLaravelOptions $options)
    {
        $header = array(
            "Accept: application/json",
            "Content-type: application/json",
    ...
    protected static function prepareAuthorizationString(Request $request, IyziLaravelOptions $options, $rnd)
    {
    ...
    protected static function prepareAuthorizationStringV2($uri, Request $request = null, IyziLaravelOptions $options, $rnd)
    {
